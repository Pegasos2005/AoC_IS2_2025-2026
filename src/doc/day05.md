...
Arquitectura:
-Modelo (FreshRangesTree): Representa la parte central donde se definen los datos y la estructura de la información. Es independiente de la interfaz. Usa un TreeHash para optimizar la adición y búsqueda de nodos que son los rangos.
-Controlador (InventoryManager): Gestiona las interacciones, procesa las operaciones solicitando al modelo que cambie o a la vista que presente los datos.
...
FreshRangesTree: Contiene un árbol con los rangos de los productos frescos, para optimizar la búsqueda (record).
...
CountFreshIds/CountAmountFreshIds: Ejecuta la lógica de iterar sobre el Arbol.
CreateRangesTree: Crea el árbol con la lista de nodos, para retornarlo al controller.
