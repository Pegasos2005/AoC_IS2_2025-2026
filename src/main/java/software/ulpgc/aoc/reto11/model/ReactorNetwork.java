package software.ulpgc.aoc.reto11.model;
...
public class ReactorNetwork {
    ...
    // Lógica principal (equivalente a rotateAndCount en tu ejemplo)
    // Calcula caminos de A a B usando memoización para eficiencia
